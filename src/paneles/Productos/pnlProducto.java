...
public class pnlProducto extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "Codigo", "Nombre", "Descripcion", "categoria", "Proveedor", "$ Compra", "$ Venta", "stock_min", "stock_max", "Estock Actual"
            }
        ) {
    ...
    private void pnlagregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnlagregarMouseClicked
        ...
        mp.titulo.setText("Registro de Productos");
    ...
    private void pnlmodificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnlmodificarMouseClicked
        if (this.tabla.getRowCount() < 1) {
            ...
            if (this.tabla.getSelectedRowCount() < 1) {
                ...
                mp.txtCodigo.setText(this.tabla.getValueAt(fila, 1).toString());
                mp.txtNombre.setText(this.tabla.getValueAt(fila, 2).toString());
                mp.txtDescripcion.setText(this.tabla.getValueAt(fila, 3).toString());
                mp.categoria.setSelectedItem(this.tabla.getValueAt(fila, 4).toString());
                mp.proveedor.setSelectedItem(this.tabla.getValueAt(fila, 5).toString());
                mp.txtPrecioCompra.setText(this.tabla.getValueAt(fila, 6).toString());
                mp.txtPrecioVenta.setText(this.tabla.getValueAt(fila, 7).toString());
                mp.txtStockmin.setText(this.tabla.getValueAt(fila, 8).toString());
                mp.txtStockmax.setText(this.tabla.getValueAt(fila, 9).toString());
                mp.txtStockactual.setText(this.tabla.getValueAt(fila, 10).toString());
                
                
                mp.titulo.setText("Modificar Productos");
                mp.registrar.setText("Guardar");
                mp.setVisible(true);
                mp.limpiar.setVisible(true);
                mp.txtStockactual.setEditable(false);
            }
        }
