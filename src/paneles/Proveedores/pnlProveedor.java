...
public class pnlProveedor extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "RFC", "Nombre", "Dirección", "Telefono", "E-mail"
            }
        ) {
    ...
    private void pnlagregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnlagregarMouseClicked
        Proveedor mp = new Proveedor(new JFrame(), true);
        mp.titulo.setText("Registro de Proveedores");
    ...
    private void pnlmodificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnlmodificarMouseClicked
        if (this.tabla.getRowCount() < 1) {
            ...
            if (this.tabla.getSelectedRowCount() < 1) {
                ...
                mp.txtRfc.setText(this.tabla.getValueAt(fila, 1).toString());
                mp.txtNombre.setText(this.tabla.getValueAt(fila, 2).toString());
                mp.txtDireccion.setText(this.tabla.getValueAt(fila, 3).toString());
                mp.txtEmail.setText(this.tabla.getValueAt(fila, 4).toString());
